package com.api.imageapi.config;

import com.api.imageapi.application.jwt.JwtService;
import com.api.imageapi.config.filter.JwtFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable).cors(cors -> cors.configure(http))
